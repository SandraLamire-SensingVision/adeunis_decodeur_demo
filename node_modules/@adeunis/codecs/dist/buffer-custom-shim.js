...
/**
 * Uint8Array::readInt32BE override for browsers compatibility
 */
...
/**
 * Uint8Array::readFloatBE override for browsers compatibility
 */
Uint8Array.prototype.readFloatBE = function (offset) {
    var dataView = new DataView(this.buffer);
...
/**
 * Uint8Array::writeFloatBE override for browsers compatibility
 */
Uint8Array.prototype.writeFloatBE = function (value, offset) {
    var dataView = new DataView(this.buffer);
