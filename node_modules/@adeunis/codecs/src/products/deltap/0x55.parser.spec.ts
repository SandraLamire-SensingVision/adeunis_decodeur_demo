...
describe('Deltap0x55Parser', () => {
  ...
  it('should parse 55A0000013882710', () => {
    const payloadString = '55A0000013882710';
    ...
    expect(content['voltage'].values[0]).to.equal(0);
    expect(content['voltage'].values[1]).to.equal(5000);
    expect(content['voltage'].values[2]).to.equal(10000);
  });
});
