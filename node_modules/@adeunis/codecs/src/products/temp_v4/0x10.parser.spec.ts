...
describe('TempV40x10Parser', () => {
  let temp0x10Parser: codec.TempV40x10Parser;

  beforeEach(() => {
    temp0x10Parser = new codec.TempV40x10Parser();
  });
  ...
  it('should parse 101021C000030002070800', () => {
    ...
    expect(content.type).to.equal('0x10 Temp 4 configuration');
