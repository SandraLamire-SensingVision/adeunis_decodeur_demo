...
describe('ComfortSerenity0x6aParser', () => {
  let parser: codec.ComfortSerenity0x6aParser;

  beforeEach(() => {
    parser = new codec.ComfortSerenity0x6aParser();
  });
  ...
  it('should parse data frame 6a8001B33E01A401B43F01A6', () => {
    ...
    expect(content.type).to.equal('0x6a Comfort Serenity data');
