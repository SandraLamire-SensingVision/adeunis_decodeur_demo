...
describe('ComfortSerenity0x6bParser', () => {
  let parser: codec.ComfortSerenity0x6bParser;

  beforeEach(() => {
    parser = new codec.ComfortSerenity0x6bParser();
  });

  it('should parse 6b800002463201A4', () => {
    const content = parser.parseFrame(Buffer.from('6b800002463201A4', 'hex'), Buffer.from(''), 'unknown');
    expect(content.type).to.equal('0x6b Comfort Serenity alarm');
