namespace codec {
  ...
  export class Decoder extends CommonDecoder {
    constructor() {
      super();
      this.deviceType = 'ticCbeLinkyMono';
    }
    ...
    protected override getActiveParsers(frameCode: number): FrameParser[] {
      ...
      // status byte parser
      const statusByteParsers = new TicStatusByteParser();
      ...
      switch (frameCode) {
        case 0x10:
          dataParser = new Tic0x10Parser();
          break;
        case 0x49:
          dataParser = new Tic0x49Parser();
          break;
        case 0x4a:
          dataParser = new Tic0x4aParser();
          break;
        case 0x20:
