namespace codec {
  ...
  export class Decoder extends CommonDecoder {
    ...
    protected override getActiveParsers(frameCode: number): FrameParser[] {
      ...
      switch (frameCode) {
        case 0x10:
          dataParser = new Comfort0x10Parser();
          break;
        case 0x4c:
          dataParser = new Comfort0x4cParser();
          break;
        case 0x4d:
          dataParser = new Comfort0x4dParser();
          break;
        case 0x1f:
