namespace codec {
  ...
  export class Decoder extends CommonDecoder {
    ...
    protected override getActiveParsers(frameCode: number): FrameParser[] {
      ...
      // status byte parser
      const statusByteParsers = new ComfortCo2StatusByteParser();
      ...
      switch (frameCode) {
        case 0x10:
          dataParser = new ComfortCo20x10Parser();
          break;
        case 0x30:
          dataParser = new ComfortCo20x30Parser();
          break;
        case 0x6a:
          dataParser = new ComfortCo20x6aParser();
          break;
        case 0x6b:
          dataParser = new ComfortCo20x6bParser();
          break;
        case 0x1f:
