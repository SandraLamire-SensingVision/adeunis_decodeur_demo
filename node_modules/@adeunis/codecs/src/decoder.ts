namespace codec {
  ...
  export class Decoder {
    ...
    protected parsers: FrameParser[] = [
      ...
      new Generic0x36Parser(),
      new Generic0x37Parser(),
      new Generic0x51Parser(),
      new Generic0x52Parser(),

      // DRYCONTACTS product
      new DrycontactsStatusByteParser(),
      new Drycontacts0x10Parser(),
      new Drycontacts0x40Parser(),

      // DRYCONTACTS 2 product
      new Drycontacts2StatusByteParser(),
      new Drycontacts20x10Parser(),
      new Drycontacts20x30Parser(),
      new Drycontacts20x40Parser(),
      new Drycontacts20x41Parser(),
      new Drycontacts20x59Parser(),
      ...
      // Pulse 4 product
      new PulseV4StatusByteParser(),
      new PulseV40x10Parser(),
      new PulseV40x11Parser(),
      new PulseV40x12Parser(),
      new PulseV40x30Parser(),
      new PulseV40x46Parser(),
      new PulseV40x47Parser(),
      new PulseV40x5aParser(),
      new PulseV40x5bParser(),

      // Pulse 4 NB-IoT product
      new PulseV4NbIotStatusByteParser(),
      new PulseV4NbIot0x10Parser(),
      new PulseV4NbIot0x20Parser(),
      new PulseV4NbIot0x30Parser(),
      new PulseV4NbIot0x33Parser(),
      new PulseV4NbIot0x46Parser(),
      new PulseV4NbIot0x47Parser(),
      new PulseV4NbIot0x5aParser(),
      new PulseV4NbIot0x5bParser(),
      ...
      // temp 4 product
      new TempV4StatusByteParser(),
      new TempV40x10Parser(),
      new TempV40x30Parser(),
      new TempV40x57Parser(),
      new TempV40x58Parser(),
      ...
      // COMFORT 2 product
      new Comfort2StatusByteParser(),
      new Comfort20x10Parser(),
      new Comfort20x4cParser(),
      new Comfort20x4dParser(),

      // COMFORT Co2 product
      new ComfortCo2StatusByteParser(),
      new ComfortCo20x10Parser(),
      new ComfortCo20x6aParser(),
      new ComfortCo20x6bParser(),
      new ComfortCo20x30Parser(),

      // COMFORT SERENITY
      new ComfortSerenityStatusByteParser(),
      new ComfortSerenity0x10Parser(),
      new ComfortSerenity0x30Parser(),
      new ComfortSerenity0x31Parser(),
      new ComfortSerenity0x38Parser(),
      new ComfortSerenity0x6aParser(),
      new ComfortSerenity0x6bParser(),
      new ComfortSerenity0x6fParser(),
      new ComfortSerenity0x70Parser(),

      // MODBUS product
      new ModbusStatusByteParser(),
      new Modbus0x10Parser(),
      new Modbus0x44Parser(), // decoding int32 values
      new Modbus0x45Parser(), // decoding uint16 values
      new Modbus0x5eParser(), // decoding uint16 values
      new Modbus0x5fParser(), // decoding int32 values
      new Modbus0x60Parser(), // decoding float(32) values
      new Modbus0x61Parser(), // decoding float(32) values
      new Modbus0x62Parser(), // decoding uint32 values
      new Modbus0x63Parser(), // decoding uint32 values
      ...
      // Analog V2 product
      new Analog2StatusByteParser(),
      new Analog20x10Parser(),
      new Analog20x30Parser(),
      new Analog20x38Parser(),
      new Analog20x42Parser(),
      new Analog20x71Parser(),
      new Analog20x72Parser(),
      ...
      // Breath product
      new BreathStatusByteParser(),
      new Breath0x6dParser(),
      new Breath0x6eParser(),
      new Breath0x10Parser(),
      new Breath0x30Parser(),
    ];
    ...
    private getActiveParsers(deviceType: string, frameCode: number) {
      ...
      let dataParser = this.parsers.filter(
        p => this.isCompatibleDeviceType(p, deviceType) && (p.frameCode < 0 || p.frameCode === frameCode)
      );
